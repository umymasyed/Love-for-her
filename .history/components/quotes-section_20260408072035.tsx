...
const loveQuotes = [
  {
    quote: "I don’t need perfect, I just need you — because with you, everything feels right 💞",
    author: "",
  },
  {
    quote: "In your smile, I found a little piece of heaven I never want to lose ✨",
    author: "",
  },
  {
    quote: "I don’t know how it happened, but you slowly became my favorite feeling 🤍",
    author: "",
  },
  {
    quote: "You’re not just in my heart… you are my heart 💖",
    author: "",
  },
  {
  ...
  {
    quote: "Every time I think of you, my heart whispers — ‘that’s my person’ 💫",
    author: "",
  },
  {
    quote: "You make my world softer, warmer, and a little more magical 💋",
    author: "",
  },
  {
    quote: "If forever exists, I just want it to be with you 💍✨",
    author: "",
  },
];
...
function TypingText({ text }) {
  ...
  useEffect(() => {
    let i = 0;
    const speed = 500; // typing speed (kam = fast)
  ...
  return (
    <p className="text-lg sm:text-xl text-foreground/90 font-light leading-relaxed whitespace-pre-line text-center max-w-3xl">
      {displayedText}
