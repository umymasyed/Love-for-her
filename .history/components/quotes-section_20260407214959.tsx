      ...
      <div className="max-w-5xl w-full">
        <div className="text-center mb-20">
          ...
          <div className="h-1 w-32 bg-gradient-to-r from-primary to-accent mx-auto rounded-full">
            Awwww youuuu reallyyy knowww howww to makeee myyyy hearttt raceee 😉🔥💋
Everyyy worddd of yoursss feels likeeee a sparkkk, anddd I can’ttt help buttt falllll deeperrr intooo youuuu 🤍🕊️✨
It’ss likeeee thisss warmthhh youuuu giveee meee… I neverrr wannaaa loseee ittt 😚💞
Justtt stayyyy closeee, becauseee withhhh youuuu everythinggg feels sooo righttt ❤️‍🔥💫
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {loveQuotes.map((item, index) => (
            <div
              ...
              className="group relative opacity-0 will-change-auto"
