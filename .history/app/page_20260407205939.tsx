    ...
    >
      ...
      <div className="relative z-10">
            ...
            <div className="space-y-6">
              ...
              <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl hover:bg-white/8 transition-all duration-300">
                <p className="text-xl sm:text-2xl text-secondary/90 font-light leading-relaxed">
                  Every moment with you feels like a dream, a symphony of hearts beating as one.
                </p>
              </div>
            </div>
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-20">
          <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-12 max-w-2xl text-center space-y-6">
            ...
            <p className="text-lg sm:text-xl text-foreground/80 leading-relaxed">
              This page was created with love, designed to celebrate the beauty of romance and the magic of connection. Every animation, every glow, every sparkle is a reflection of the feelings that make life worth living.
            </p>
            <div className="flex justify-center gap-4 pt-8">
              <button className="group relative px-8 py-3 rounded-full bg-gradient-to-r from-primary to-accent text-white font-semibold overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-accent to-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <span className="relative flex items-center gap-2">
                  <span>💌</span> Share Your Love
                </span>
              </button>
            </div>
          </div>
